...
export default [
  {
    ...
    title: `vogi`,
    content:
      'A project management app that provides a user friendly dashboard where users can create projects, add project features, and track project completion progress by integrating GitHub API.'
  },
  {
    source: portfolio,
